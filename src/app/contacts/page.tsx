export default function Constacts() {
    return (
        <div className="justify-center mx-8 space-y-12 mb-12 bg-white dark:bg-gray-800">
            ...
            <div className="grid gap-5 lg:md:grid-cols-2 sm:grid-cols-1">
                <dl className="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    ...
                    <div className="flex flex-col py-3">
                        ...
                        <dd className="text-lg font-semibold">Подгорая ул., 32, Переславль-Залесский, Ярославская обл., 152024</dd>
                    </div>
